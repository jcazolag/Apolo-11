...
def main():
    try:
        ...
        ruta_devices = os.path.join(ruta_preferencia, "devices")
        ...
        menu_util = menu.MenuUtil()
        archivos_existentes = au.files_search(".log", ruta_devices)
        if (archivos_existentes):
            menu_util.menu_existen_archivos(len(archivos_existentes))
        else:
